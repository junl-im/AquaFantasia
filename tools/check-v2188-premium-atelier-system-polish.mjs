...
const fail = (msg) => { console.error(`[v2188] ${msg}`); process.exit(1); };
...
if (pkg.version !== '2.1.88') fail(`package.json version is ${pkg.version}`);
if (lock.version !== '2.1.88' || lock.packages?.['']?.version !== '2.1.88') fail('package-lock.json version mismatch');
if (!pkg.scripts?.validate?.includes('check-v2188-premium-atelier-system-polish.mjs')) fail('validate script must run v2.1.88 guard');
assertIncludes('src/data.ts', "APP_VERSION = '2.1.88'");
assertIncludes('src/data.ts', 'aqua-fantasia-v2.1.88-premium-atelier-system-polish');
assertIncludes('public/sw.js', 'aqua-fantasia-v2.1.88-premium-atelier-system-polish');
assertIncludes('public/offline.html', 'v2.1.88');
assertIncludes('README.md', '# AquaFantasia v2.1.88');
...
for (const token of [
  ...
  'installV2188PremiumAtelierSystemPolishPass',
  'dataset.v2188PremiumAtelierSystemPolish',
  'v2188-premium-atelier-system-root',
  'premium-atelier-design-fishing-safe-result-performance',
  'v2188-fishing-atelier-screen',
  'atelier-safe-shelf-bite-result-no-overlap',
  'v2188-sea-lane-card',
  'v2188-fishing-loadout',
  'v2188-loadout-cell',
  'v2188-loadout-copy',
  'v2188-readable-text',
  'v2188-bite-callout',
  'v2188-focused-phase-no-overlap',
  'v2188-gauge-lifecycle-cleanup',
  'v2188-result-card',
  'v2188-result-rarity-compact',
  'v2188-result-impact',
  'v2188-village-design-stability-screen',
  'v2188-hud-frontier-gap',
  'v2188-premium-aqua-card',
  'v2188-readable-input',
]) if (!main.includes(token)) fail(`src/main.ts missing ${token}`);
for (const token of [
  '/* v2.1.88: premium atelier/system polish',
  'html.v2188-premium-atelier-system-root',
  'body[data-screen="fishing"] .v2188-sea-lane-card',
  '.v2188-fishing-loadout',
  '.v2188-loadout-cell',
  '.v2188-loadout-copy',
  '.v2188-readable-text',
  ...
  '.v2188-bite-callout',
  'top: var(--v2188-bite-top) !important;',
  'data-v2188-fishing-phase="bite"',
  '.v2188-gauge-cleanup-node',
...
console.log('[v2188] premium atelier design, fishing shelf/bite/result, village stability, opening/player direction/package checks passed');
