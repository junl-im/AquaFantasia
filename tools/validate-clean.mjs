...
const required = [
  ...
  'public/sw.js','public/manifest.webmanifest','public/assets/v85/screens/start_screen_clean_v810.webp','public/assets/v85/compositions/town.webp','public/assets/v85/compositions/fishing.webp','public/assets/v85/compositions/gear.webp','public/assets/v85/compositions/inventory.webp','public/assets/v85/compositions/dex.webp','public/assets/v85/compositions/shop.webp','public/assets/v85/compositions/mission.webp','public/assets/v85/compositions/ranking.webp','public/assets/v85/bg/ocean_full.webp','public/assets/v85/characters/chibi_fisher_01_hd.png','public/assets/v85/fish/fish_01.png','public/assets/ui/v750_button_gold.png','public/assets/ui/v750_keep_on.png',
  'public/assets/v9/ui/bottom_nav_bar_deepblue.png','public/assets/v84/characters/chibi_fisher_01_hd.png','public/assets/v84/bg/ocean_full.webp','public/assets/v12/fish/fish_01.png',
...
if (!data.includes("APP_VERSION = '8.5.0'")) fail('APP_VERSION is not 8.5.0');
if (!data.includes('aqua-fantasia-v8.5.0-hd-image-fidelity')) fail('CACHE_NAME mismatch');
const pkg = JSON.parse(fs.readFileSync(path.join(root,'package.json'),'utf8'));
if (pkg.version !== '8.5.0') fail('package version mismatch');
...
console.log('[validate-clean] Aqua Fantasia v8.5.0 hd image fidelity OK');
console.log(JSON.stringify({ ok:true, version:'8.5.0', files: walk(root).length }, null, 2));
