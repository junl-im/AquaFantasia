...
class AquaFantasiaGame {
  ...
  async boot(): Promise<void> {
    ...
    document.documentElement.dataset.villagePolish = 'v2010-asset-layout-polish';
  ...
  private renderVillage(): void {
    ...
    this.clear();
    const root = document.createElement('main');
    root.className = 'game-screen village-world-screen v2-village-screen v202-mobile-rpg-screen v203-asset-pass-screen v204-asset-ui-screen v206-village-detail-screen v207-layout-bugfix-screen v208-right-dock-screen v209-asset-qa-screen v2010-village-clean-screen locked-screen';
  ...
  private mountBottomNav(root: HTMLElement, active: Screen): void {
    ...
    const v13 = false;
    nav.className = 'bottom-nav premium-bottom-nav fixed-root-nav v840-bottom-nav v208-right-dock-nav v2010-right-dock-nav';
    ...
    const dockInlineStyles: Array<[string, string]> = [
      ...
      ['grid-template-columns', 'repeat(2, var(--v2010-dock-button, 76px))'],
      ['grid-auto-rows', 'var(--v2010-dock-button, 76px)'], ['gap', 'var(--v2010-dock-gap, 10px)'],
