...
if (!/aqua-fantasia-v2\.0\.(5[8-9]|[6-9][0-9])/.test(data)) fail('CACHE_NAME must keep v2058+ modernization lineage');
if (!/aqua-fantasia-v2\.0\.(5[8-9]|[6-9][0-9])/.test(sw)) fail('service worker cache must keep v2058+ cache lineage');
