...
class AquaFantasiaGame {
  ...
  private clear(): void {
    ...
    document.body.classList.remove('v2032-character-panel-open', 'v2033-character-panel-open', 'v2034-character-panel-open', 'v2035-character-panel-open', 'v2036-character-panel-open', 'v2037-character-panel-open', 'v2039-character-panel-open', 'v2040-character-panel-open', 'v2041-character-panel-open', 'v2042-character-panel-open', 'v2040-interior-open', 'v2041-interior-open', 'v2042-interior-open', 'v2043-interior-open');
  ...
  private renderVillage(): void {
    ...
    root.innerHTML = `
      ...
      <div class="v2-world-controls" aria-label="마을 조작">
        <button type="button" data-village-zoom-in aria-label="확대"><span class="v2043-control-icon" aria-hidden="true">＋</span><span class="v2043-control-label">확대</span></button>
        <button type="button" data-village-zoom-out aria-label="축소"><span class="v2043-control-icon" aria-hidden="true">－</span><span class="v2043-control-label">축소</span></button>
        <button type="button" data-village-center aria-label="플레이어 위치로 이동"><span class="v2043-control-icon" aria-hidden="true">◎</span><span class="v2043-control-label">원점</span></button>
        <button type="button" data-village-build-open aria-label="건설 메뉴 열기"><span class="v2043-control-icon" aria-hidden="true"><img src="./assets/v22/icons/nav_build.png" alt="" /></span><span class="v2043-control-label">건설</span></button>
        <button type="button" data-village-shop aria-label="상점 열기"><span class="v2043-control-icon" aria-hidden="true"><img src="./assets/v92/icons/shop.png" alt="" /></span><span class="v2043-control-label">상점</span></button>
        <button type="button" data-village-fishing aria-label="항구 출항"><span class="v2043-control-icon" aria-hidden="true"><img src="./assets/v22/icons/nav_fishing.png" alt="" /></span><span class="v2043-control-label">출항</span></button>
      </div>
  ...
  private async renderFishing(): Promise<void> {
    ...
    root.innerHTML = `
      ...
      <div class="fishing-stage v2028-fishing-stage v2030-fishing-stage v2031-fishing-stage v2032-fishing-stage v2033-fishing-stage v2034-fishing-stage v2035-fishing-stage v2036-fishing-stage v2037-fishing-stage v2038-fishing-stage v2039-fishing-stage v2040-fishing-stage v2041-fishing-stage v2042-fishing-stage v2043-fishing-stage" id="fishingStage">
        ...
        <div class="fishing-guide-card v205-guide-card v2029-fishing-guide-card v2030-fishing-guide-card v2031-fishing-guide-card v2038-fishing-guide-card v2039-fishing-guide-card v2040-fishing-guide-card v2041-fishing-guide-card" aria-hidden="true"><strong>낚시 준비</strong><span data-fishing-tip>찌를 던지고 물었다!가 뜨면 화면을 눌러 당기세요.</span></div>
      </div>
      <div class="fishing-hud v205-fishing-hud v2028-fishing-hud v2029-fishing-hud v2030-fishing-hud v2031-fishing-hud v2032-fishing-hud v2033-fishing-hud v2034-fishing-hud v2035-fishing-hud v2036-fishing-hud v2037-fishing-hud v2038-fishing-hud v2039-fishing-hud v2040-fishing-hud v2041-fishing-hud v2043-fishing-hud" aria-label="플레이어 정보">
  ...
  private mountBottomNav(root: HTMLElement, active: Screen): void {
    ...
    const dockInlineStyles: Array<[string, string]> = [
      ['position', 'fixed'], ['left', 'auto'], ['right', 'var(--v2040-dock-right, var(--v2037-dock-right, var(--v2036-dock-right, max(10px, env(safe-area-inset-right)))))'],
      ['bottom', 'var(--v2040-dock-bottom, var(--v2037-dock-bottom, var(--v2036-dock-bottom, calc(max(14px, env(safe-area-inset-bottom)) + 6px))))'], ['width', 'auto'], ['height', 'auto'],
      ['min-width', '0'], ['max-width', 'calc(100vw - 16px)'], ['display', 'grid'],
      ['grid-template-columns', 'repeat(3, var(--v2040-dock-button, var(--v2037-dock-button, var(--v2036-dock-button, 52px))))'],
      ['grid-template-rows', 'repeat(2, var(--v2040-dock-button, var(--v2037-dock-button, var(--v2036-dock-button, 52px))))'], ['gap', 'var(--v2040-dock-gap, var(--v2037-dock-gap, var(--v2036-dock-gap, 4px)))'],
  ...
  private showResultCard(reward: number): void {
    ...
    card.className = `catch-result-card v930-result v2021-result-card v2036-result-card v2037-result-card v2038-result-card v2039-result-card v2040-result-card v2041-result-card v2042-result-card v2043-result-card rarity-${this.activeFish.rarity.toLowerCase()}`;
  ...
  private spawnActionBadge(title: string, subtitle: string): void {
    ...
    badge.className = 'action-badge v930-fx v2030-action-badge v2040-action-badge v2041-action-badge v2042-action-badge v2043-action-badge';
  ...
  private showBiteCallout(title: string): void {
    ...
    callout.className = 'bite-callout v2030-bite-callout v2041-bite-callout v2042-bite-callout v2043-bite-callout';
  ...
  private renderShop(): void {
    ...
    const content = root.querySelector<HTMLDivElement>('.runtime-content')!;
    content.innerHTML = `
      <section class="runtime-hero-card shop-summary v2042-shop-summary v2043-shop-summary">
