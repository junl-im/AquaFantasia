...
const fail = (msg) => { console.error(`[v2160] ${msg}`); process.exit(1); };
...
if (pkg.version !== '2.1.60') fail(`package.json version is ${pkg.version}`);
if (lock.version !== '2.1.60' || lock.packages?.['']?.version !== '2.1.60') fail('package-lock.json version mismatch');
if (!pkg.scripts?.validate?.includes('check-v2160-fishing-hud-menu-polish.mjs')) fail('validate script must run v2.1.60 guard');
assertIncludes('src/data.ts', "APP_VERSION = '2.1.60'");
assertIncludes('src/data.ts', 'aqua-fantasia-v2.1.60-fishing-hud-menu-polish');
assertIncludes('public/sw.js', 'aqua-fantasia-v2.1.60-fishing-hud-menu-polish');
assertIncludes('public/offline.html', 'v2.1.60');
assertIncludes('README.md', '# AquaFantasia v2.1.60');
assertIncludes('README.md', '## v2.1.60 변경사항');
...
for (const token of [
  'dataset.v2160FishingHudMenuPolish',
  'v2160-fishing-hud-menu-polish-root',
  'v2160-world-controls-aqua-lock',
  'data-v2160-primary-order',
  'v2160HudMenuCheck',
  '2x3-32px-21px-3px-no-frame-hud-clear-safe-area',
  'v2160-top-menu-cell',
  ...
  'v2160-bottom-nav',
  'same-position-icon-clip-no-shift-safe-area-aqua',
  'v2160-fishing-premium-focus-screen',
  'v2160-fishing-stage',
  'v2160-sea-lane-card',
  'v2160-fishing-loadout',
  'v2160-battle-strip',
  'data-v2160-catch-bar',
  'data-v2160-tension-bar',
  'data-v2160-stamina-bar',
  'data-v2160-safe-window',
  '[data-v2160-catch-bar], [data-v2159-catch-bar]',
  'v2160-reel-console',
  'v2160-single-reel-button',
  'v2160-release-hidden',
  'v2160-cast-button',
  '떼면 자동 풀기',
  'v2158-opening-video',
...
for (const token of [
  'v2.1.60: fishing UI, HUD spacing, and right-top 2x3 menu size audit polish.',
  '--v2160-aqua-card',
  '.v2160-world-controls-aqua-lock',
  ...
  '.v2160-bottom-nav .v2098-nav-item img',
...
for (const token of [
  '낚시 실전 단계에서 포획/텐션/저항 게이지와 단일 감기 버튼',
  '바다물길/장비/캐스팅',
  'HUD와 개척 바',
...
console.log('[v2160] fishing UI, HUD spacing, top menu size, direction, opening, and packaging guards passed');
