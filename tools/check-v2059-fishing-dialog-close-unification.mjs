...
if (!/aqua-fantasia-v2\.0\.(59|[6-9][0-9])/.test(data)) fail('CACHE_NAME must keep v2.0.59+ cache lineage');
if (!/aqua-fantasia-v2\.0\.(59|[6-9][0-9])/.test(sw)) fail('service worker cache must keep v2.0.59+ cache lineage');
