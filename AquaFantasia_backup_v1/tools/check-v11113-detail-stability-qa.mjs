...
assert(/^1\.1\.(1[3-9]|[2-9][0-9])$/.test(pkg.version), 'package version keeps v1.1.13+ detail stability lineage');
...
assert(readme.includes(`v${pkg.version}`) || readme.includes('v1.1.13 Detail Stability QA'), 'README documents current lineage');
