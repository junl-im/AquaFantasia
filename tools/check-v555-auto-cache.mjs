...
if (!(index.includes('v555-auto-cache-sweep.js?v=5.5.5') || index.includes('v555-auto-cache-sweep.js?v=5.6.1') || index.includes('v555-auto-cache-sweep.js?v=5.7.0') || index.includes('v555-auto-cache-sweep.js?v=5.8.0') || index.includes('v555-auto-cache-sweep.js?v=5.9.0')) || !index.includes('v5.5.5 Auto Cache Sweep')) fail('index v5.5.5 auto cache runtime markers missing');
...
if (!(sw.includes('aqua-fantasia-v5.8.0-2-5d-art-20260612') || sw.includes('aqua-fantasia-v5.7.0-water-art-20260612') || sw.includes('aqua-fantasia-v5.6.1-ui-cleanup-20260612') || sw.includes('aqua-fantasia-v5.6.0-background-art-20260612') || sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612')) || !sw.includes('./src/runtime/v555-auto-cache-sweep.js')) fail('service worker v5.5.5/v5.6 cache version/entry missing');
...
if (!manifest.includes('Auto Cache Sweep') || !(manifest.includes('5.8.0-2-5d-art-20260612') || manifest.includes('5.7.0-water-art-20260612') || manifest.includes('5.6.1-ui-cleanup-20260612') || manifest.includes('5.6.0-background-art-20260612') || manifest.includes('5.5.5-auto-cache-sweep-20260612'))) fail('manifest auto cache markers missing');
