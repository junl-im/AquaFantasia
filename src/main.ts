...
class AquaFantasiaGame {
  ...
  async boot(): Promise<void> {
    ...
    // v2.1.17 UI policy: layout/input/fishing polish. Keep the approved login toggle fixed while correcting modal placement, joystick motion, dock stability, water tiles, and fishing reel centering.
  ...
  private activateV2097UiResetShell(): void {
    ...
    const keep = new Set(['version', 'cacheName', 'initialOrientation', 'orientationPolicy', 'v2097UiReset', 'v2098UiRecovery', 'v218StableRollback', 'v219UiTouchShopFishingAudit', 'v2111AquaShell', 'v2112AquaFoundation', 'v2113AquaCoreSteward', 'v2114InteractionShellPolish', 'v2115AquaScreenShell', 'v2116VillageAssetPolish', 'v2117LayoutInputFishing']);
  ...
  private renderLogin(): void {
    ...
    shell.className = 'login-screen start-art-screen v2025-start-guard-screen v2084-start-shell v2115-start-shell v2116-start-shell v2117-start-shell';
...
// v2.0.97 validation lineage only: this.mountBottomNav(root, 'village');
  ...
  private renderVillage(): void {
    ...
    const root = document.createElement('main');
    root.className = 'game-screen village-world-screen v2097-village-screen v2098-village-screen v2111-village-shell v2112-village-foundation v2113-village-core v2114-village-interaction v2115-village-shell v2116-village-asset-shell v2116-village-asset-polish v2117-village-layout-polish v2115-village-loading-state v2116-village-loading-state v2117-village-loading-state locked-screen';
    ...
    root.innerHTML = `
      ...
      <section class="v2097-expedition-board v2098-expedition-board aqua-card-mini-bar" aria-label="다른 섬 개척 준비 보드">
        ...
        <div class="v2097-expedition-body v2098-expedition-body aqua-card-surface aqua-card-dialog v2115-aqua-card v2116-aqua-card v2117-aqua-card" data-v2097-expedition-body data-v2098-expedition-body aria-hidden="true">${this.islandExpansionBoardMarkup()}<button type="button" class="v2097-ui-close v2097-expedition-close" data-v2097-expedition-close aria-label="정보 닫기">×</button></div>
      </section>
      ...
      <aside class="v2097-build-tray v2111-aqua-card v2115-aqua-card v2116-aqua-card v2117-aqua-card" aria-label="건물 설치 모드" role="dialog" aria-modal="true">
      ...
      <div class="v2097-world-controls v2098-world-controls v2115-world-controls v2116-world-controls v2117-world-controls" data-v2117-primary-order="plus-minus-build-center-shop-sail" data-v2115-primary-order="plus-minus-build-center-shop-sail" data-v2116-primary-order="plus-minus-build-center-shop-sail" aria-label="마을 조작">
    ...
    root.classList.add('v2113-controls-mounted', 'v2114-controls-mounted', 'v2116-controls-mounted', 'v2117-controls-mounted');
    ...
    void this.villageWorld.init().then(() => {
      root.classList.add('v2097-village-ready', 'v2115-village-ready', 'v2116-village-ready', 'v2117-village-ready');
      root.classList.remove('v2115-village-loading-state', 'v2116-village-loading-state', 'v2117-village-loading-state');
  ...
  private createRuntimeMenuScreen(active: Exclude<Screen, 'login' | 'fishing'>, title: string, subtitle: string): HTMLElement {
    this.clear();
    const root = document.createElement('main');
    root.className = `game-screen runtime-menu-screen v2097-menu-screen v2098-menu-screen v218-runtime-page-screen v219-runtime-page-screen v2111-runtime-page-shell v2112-runtime-page-shell v2113-runtime-page-shell v2114-runtime-page-shell v2115-runtime-page-shell v2116-runtime-page-shell v2117-runtime-page-shell v2097-${active}-screen v2098-${active}-screen ${active}-screen scroll-screen`;
    ...
    root.innerHTML = `
      ...
      <div class="runtime-content v2097-menu-content v2098-menu-content v2111-aqua-page v2112-aqua-page v2113-aqua-page v2114-aqua-page v2115-aqua-page v2116-aqua-page v2117-aqua-page v2097-${active}-content v2098-${active}-content" data-v2097-scroll-root="true" data-v2098-scroll-root="true"></div>`;
...
// v2.0.93 validation lineage only: root.dataset.v2090UiDebtCleanup = `stable-clean-${active}`;
  ...
  private mountBottomNav(root: HTMLElement, active: Screen): void {
    ...
    nav.className = 'bottom-nav v2098-bottom-nav v2111-bottom-nav v2112-bottom-nav v2113-bottom-nav v2114-bottom-nav v2115-bottom-nav v2116-bottom-nav v2117-bottom-nav';
  ...
  private repairBottomNavBounds(nav: HTMLElement): void {
    ...
    if (nav.classList.contains('v2117-bottom-nav') || nav.classList.contains('v2116-bottom-nav')) {
