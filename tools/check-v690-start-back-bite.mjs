...
if (!data.includes('6.9.0') || !data.includes('aqua-fantasia-v6.9.0-start-back-bite-polish')) fail('v6.9 data/cache missing');
if (!sw.includes('start_screen_clean_v690.webp')) fail('clean start screen is not precached');
if (pkg.version !== '6.9.0') fail('package version must be 6.9.0');
