...
if (!index.includes('v56-background-art-pass.js?v=5.6.0') || !index.includes('v5.6.0 Background Art Pass')) fail('index v5.6 runtime marker missing');
if (!index.includes("const APP_VERSION = '5.6.0'")) fail('index APP_VERSION must be 5.6.0');
...
if (!sw.includes('aqua-fantasia-v5.6.0-background-art-20260612') || !sw.includes('./src/runtime/v56-background-art-pass.js')) fail('service worker v5.6 cache entry missing');
...
if (!manifest.includes('v5.6.0 Background Art Pass') || !manifest.includes('5.6.0-background-art-20260612')) fail('manifest v5.6 markers missing');
if (!pkg.includes('runtime56:check') || !pkg.includes('check-v56-background-art.mjs')) fail('package v5.6 script missing');
if (!state.includes("background: 'assets/art/v56_fishing_bg_lake.webp'") || !state.includes("APP_VERSION = '5.6.0'")) fail('core state background/version not updated');
