...
const fail = (msg) => { console.error(`[v2187] ${msg}`); process.exit(1); };
...
if (pkg.version !== '2.1.87') fail(`package.json version is ${pkg.version}`);
if (lock.version !== '2.1.87' || lock.packages?.['']?.version !== '2.1.87') fail('package-lock.json version mismatch');
if (!pkg.scripts?.validate?.includes('check-v2187-premium-design-system-upgrade.mjs')) fail('validate script must run v2.1.87 guard');
assertIncludes('src/data.ts', "APP_VERSION = '2.1.87'");
assertIncludes('src/data.ts', 'aqua-fantasia-v2.1.87-premium-design-system-upgrade');
assertIncludes('public/sw.js', 'aqua-fantasia-v2.1.87-premium-design-system-upgrade');
assertIncludes('public/offline.html', 'v2.1.87');
assertIncludes('README.md', '# AquaFantasia v2.1.87');
assertIncludes('README.md', '## v2.1.87 변경사항');
...
for (const token of [
  ...
  'installV2187PremiumDesignSystemUpgradePass',
  'dataset.v2187PremiumDesignSystemUpgrade',
  'v2187-premium-design-system-root',
  'premium-aqua-design-fishing-result-performance-upgrade',
  'v2187-fishing-premium-screen',
  'premium-safe-shelf-bite-result-no-overlap',
  'v2187-sea-lane-card',
  'v2187-fishing-loadout',
  'v2187-loadout-cell',
  'v2187-loadout-copy',
  'v2187-readable-text',
  'v2187-bite-callout',
  'v2187-focused-phase-no-overlap',
  'v2187-gauge-lifecycle-cleanup',
  'v2187-result-card',
  'v2187-result-rarity-compact',
  'v2187-result-impact',
  'v2187-village-design-stability-screen',
  'v2187-hud-frontier-gap',
  'v2187-premium-aqua-card',
]) if (!main.includes(token)) fail(`src/main.ts missing ${token}`);
for (const token of [
  '/* v2.1.87: premium design/system upgrade',
  'html.v2187-premium-design-system-root',
  'body[data-screen="fishing"] .v2187-sea-lane-card',
  '.v2187-fishing-loadout',
  '.v2187-loadout-cell',
  '.v2187-loadout-copy',
  '.v2187-readable-text',
  ...
  '.v2187-bite-callout',
  'top: var(--v2187-bite-top) !important;',
  'data-v2187-fishing-phase="bite"',
  '.v2187-gauge-cleanup-node',
...
console.log('[v2187] premium design, fishing shelf/bite/result, village stability, opening/player direction/package checks passed');
