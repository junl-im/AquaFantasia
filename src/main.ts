...
// v2.0.97 validation lineage only: this.mountBottomNav(root, 'village');
  ...
  private applyV2158TopMenuBalanced(root: HTMLElement): void {
    ...
    if (!controls) return;
    controls.classList.add('v2156-world-controls-fixed', 'v2157-world-controls-microbar', 'v2158-world-controls-balanced', 'v2159-world-controls-aqua-lock');
    ...
    controls.querySelectorAll<HTMLElement>('button').forEach((button) => {
      button.classList.add('v2156-top-menu-cell', 'v2157-top-menu-cell', 'v2158-top-menu-cell', 'v2159-top-menu-cell');
...
// v2.0.93 validation lineage only: root.dataset.v2090UiDebtCleanup = `stable-clean-${active}`;
  ...
  private async renderFishing(): Promise<void> {
    ...
    root.innerHTML = `
      ...
      <aside class="v2137-sea-lane-card v2138-sea-lane-card v2139-sea-lane-card v2140-sea-lane-card v2142-sea-lane-card v2143-sea-lane-card v2144-sea-lane-card v2145-sea-lane-card v2146-sea-lane-card v2147-sea-lane-card v2148-sea-lane-card v2149-sea-lane-card v2150-sea-lane-card v2151-sea-lane-card v2152-sea-lane-card v2153-sea-lane-card v2154-sea-lane-card v2155-sea-lane-card v2158-sea-lane-card v2159-sea-lane-card" aria-label="선택 수역 물길 정보"><span>바다물길</span><strong>${region.name}</strong><em>${region.subtitle} · ${region.tide}</em></aside>
      <div class="stage-ui v2028-stage-ui"></div><div class="cute-action-layer" aria-hidden="true"></div>
      <aside class="fishing-loadout-strip v2137-fishing-loadout v2138-fishing-loadout v2139-fishing-loadout v2140-fishing-loadout v2142-fishing-loadout v2143-fishing-loadout v2144-fishing-loadout v2145-fishing-loadout v2146-fishing-loadout v2147-fishing-loadout v2148-fishing-loadout v2149-fishing-loadout v2150-fishing-loadout v2151-fishing-loadout v2152-fishing-loadout v2153-fishing-loadout v2154-fishing-loadout v2155-fishing-loadout v2158-fishing-loadout v2159-fishing-loadout" aria-label="낚시 장비">
      ...
      <section class="v2153-battle-strip v2154-battle-strip v2155-battle-strip v2156-battle-strip v2157-battle-strip v2158-battle-strip v2159-battle-strip" aria-live="polite" aria-label="낚시 실전 게이지">
        <div class="v2153-battle-row v2153-battle-catch"><span>포획</span><i><b data-v2153-catch-bar data-v2154-catch-bar data-v2155-catch-bar data-v2156-catch-bar data-v2157-catch-bar data-v2158-catch-bar data-v2159-catch-bar></b></i><strong data-v2153-catch-value data-v2154-catch-value data-v2155-catch-value data-v2156-catch-value data-v2157-catch-value data-v2158-catch-value data-v2159-catch-value>0%</strong></div>
        <div class="v2153-battle-row v2153-battle-tension"><span>텐션</span><i><em data-v2153-safe-window data-v2154-safe-window data-v2155-safe-window data-v2156-safe-window data-v2157-safe-window data-v2158-safe-window data-v2159-safe-window></em><b data-v2153-tension-bar data-v2154-tension-bar data-v2155-tension-bar data-v2156-tension-bar data-v2157-tension-bar data-v2158-tension-bar data-v2159-tension-bar></b></i><strong data-v2153-tension-value data-v2154-tension-value data-v2155-tension-value data-v2156-tension-value data-v2157-tension-value data-v2158-tension-value data-v2159-tension-value>50%</strong></div>
        <div class="v2153-battle-row v2153-battle-stamina"><span>저항</span><i><b data-v2153-stamina-bar data-v2154-stamina-bar data-v2155-stamina-bar data-v2156-stamina-bar data-v2157-stamina-bar data-v2158-stamina-bar data-v2159-stamina-bar></b></i><strong data-v2153-stamina-value data-v2154-stamina-value data-v2155-stamina-value data-v2156-stamina-value data-v2157-stamina-value data-v2158-stamina-value data-v2159-stamina-value>100%</strong></div>
      </section>
      ...
      <section class="v2055-reel-console v2057-reel-console v2073-reel-console v2131-reel-console v2132-reel-console v2134-reel-console v2135-reel-console v2136-reel-console v2137-reel-console v2138-reel-console v2139-reel-console v2140-reel-console v2142-reel-console v2143-reel-console v2144-reel-console v2145-reel-console v2146-reel-console v2147-reel-console v2148-reel-console v2149-reel-console v2150-reel-console v2151-reel-console v2152-reel-console v2153-reel-console v2154-reel-console v2155-reel-console v2156-reel-console v2157-reel-console v2158-reel-console v2159-reel-console hidden" id="reelConsole" aria-label="낚시 릴 조작 패널">
        ...
        <div class="v2131-reel-console-title v2132-reel-console-title"><strong>릴 콘솔</strong><span>감기/풀기 모두 손을 떼면 즉시 중립으로 돌아갑니다</span></div><div class="v2055-reel-actions v2131-reel-actions">
          <button type="button" class="v2055-reel-wind v2057-reel-button v2158-single-reel-button v2159-single-reel-button" data-v2055-reel-wind><strong>누르고 찌 감기</strong><span>떼면 자동 풀기</span></button>
          <button type="button" class="v2055-reel-release v2057-reel-button v2158-release-hidden v2159-release-hidden" data-v2055-reel-release aria-hidden="true" tabindex="-1"><strong>풀기</strong><span>실전 UI에서는 손을 떼면 자동 풀기</span></button>
        </div>
  ...
  private applyV2133UiEngineGuard(root: HTMLElement, nav?: HTMLElement): void {
    root.classList.add('v2133-ui-engine-screen', 'v2159-premium-aqua-ui-screen', 'v2134-ui-engine-screen', 'v2135-ui-engine-screen', 'v2136-ui-engine-screen', 'v2137-ui-engine-screen', 'v2138-ui-engine-screen', 'v2139-ui-engine-screen', 'v2143-ui-overlap-sweep-screen', 'v2145-icon-page-polish-screen', 'v2146-ui-overlap-icon-polish-screen', 'v2147-ui-overlap-layout-polish-screen', 'v2149-ui-composition-polish-screen', 'v2150-overlap-placement-beauty-screen', 'v2155-page-overlap-polish-screen', 'v2159-page-overlap-polish-screen');
  ...
  private updateTensionUI(): void {
    ...
    const battleCatchBar = dom.app.querySelector<HTMLElement>('[data-v2159-catch-bar], [data-v2158-catch-bar], [data-v2157-catch-bar], [data-v2156-catch-bar], [data-v2155-catch-bar], [data-v2154-catch-bar], [data-v2153-catch-bar]');
    const battleCatchValue = dom.app.querySelector<HTMLElement>('[data-v2159-catch-value], [data-v2158-catch-value], [data-v2157-catch-value], [data-v2156-catch-value], [data-v2155-catch-value], [data-v2154-catch-value], [data-v2153-catch-value]');
    const battleTensionBar = dom.app.querySelector<HTMLElement>('[data-v2159-tension-bar], [data-v2158-tension-bar], [data-v2157-tension-bar], [data-v2156-tension-bar], [data-v2155-tension-bar], [data-v2154-tension-bar], [data-v2153-tension-bar]');
    const battleTensionValue = dom.app.querySelector<HTMLElement>('[data-v2159-tension-value], [data-v2158-tension-value], [data-v2157-tension-value], [data-v2156-tension-value], [data-v2155-tension-value], [data-v2154-tension-value], [data-v2153-tension-value]');
    const battleStaminaBar = dom.app.querySelector<HTMLElement>('[data-v2159-stamina-bar], [data-v2158-stamina-bar], [data-v2157-stamina-bar], [data-v2156-stamina-bar], [data-v2155-stamina-bar], [data-v2154-stamina-bar], [data-v2153-stamina-bar]');
    const battleStaminaValue = dom.app.querySelector<HTMLElement>('[data-v2159-stamina-value], [data-v2158-stamina-value], [data-v2157-stamina-value], [data-v2156-stamina-value], [data-v2155-stamina-value], [data-v2154-stamina-value], [data-v2153-stamina-value]');
    const battleSafeWindow = dom.app.querySelector<HTMLElement>('[data-v2159-safe-window], [data-v2158-safe-window], [data-v2157-safe-window], [data-v2156-safe-window], [data-v2155-safe-window], [data-v2154-safe-window], [data-v2153-safe-window]');
