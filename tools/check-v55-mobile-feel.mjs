...
if (!hasAny(state, ["APP_VERSION = '5.5.0'", "APP_VERSION = '5.5.1'", "APP_VERSION = '5.5.2'", "APP_VERSION = '5.5.5'", "APP_VERSION = '5.6.0'", "APP_VERSION = '5.6.1'", "APP_VERSION = '5.7.0'", "APP_VERSION = '5.8.0'", "APP_VERSION = '5.9.0'"]) || !state.includes('aqua_v5.5')) fail('state v5.5 version/save markers missing');
if (!index.includes('v55-mobile-feel-runtime.js') || !index.includes('v5.5 Mobile Feel') || !hasAny(index, ["const APP_VERSION = '5.5.0'", "const APP_VERSION = '5.5.1'", "const APP_VERSION = '5.5.2'", "const APP_VERSION = '5.5.5'", "const APP_VERSION = '5.6.0'", "const APP_VERSION = '5.6.1'", "const APP_VERSION = '5.7.0'", "const APP_VERSION = '5.8.0'", "const APP_VERSION = '5.9.0'"])) fail('index v5.5 markers missing');
...
if (!hasAny(sw, ['aqua-fantasia-v5.5.0-mobile-feel-20260612', 'aqua-fantasia-v5.5.1-hotfix-20260612', 'aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612', 'aqua-fantasia-v5.5.5-auto-cache-sweep-20260612', 'aqua-fantasia-v5.6.0-background-art-20260612', 'aqua-fantasia-v5.6.1-ui-cleanup-20260612', 'aqua-fantasia-v5.7.0-water-art-20260612']) || !sw.includes('./src/runtime/v55-mobile-feel-runtime.js') || !sw.includes('keepPrefix')) fail('service worker v5.5 cache guard markers missing');
