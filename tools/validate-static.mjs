...
const required = [
  ...
  'assets/atlas/aqua_fishing_v50.webp','assets/atlas/aqua_fishing_v50.atlas.json','src/runtime/v50-performance-runtime.js',
  'PATCH_NOTES_v4.9.md','V4_9_RUNTIME_CONNECT_CHECKLIST.md','PATCH_NOTES_v5.0.md','V5_0_PERFORMANCE_FOCUS_CHECKLIST.md',
  'tools/audit-bundle.mjs','tools/check-v47-renderer.mjs','tools/check-v48-runtime.mjs','tools/check-v49-runtime.mjs','tools/check-v50-runtime.mjs','tools/clean-bundle-report.mjs'
];
...
if (!index.includes("const APP_VERSION = '5.0.0'")) fail('APP_VERSION must be 5.0.0.');
if (!index.includes('v5.0 Performance Focus') && !index.includes('PERFORMANCE 5.0')) fail('v5.0 performance focus marker is missing.');
...
if (!index.includes('aqua_v5.0') || !index.includes('aqua_v4.9') || !index.includes('aqua_latest_state')) fail('v5.0 save keys are missing.');
...
if (!sw.includes('aqua-fantasia-v5.0.0')) fail('Service worker cache version must be v5.0.0.');
...
console.log('[validate-static] AquaFantasia v5.0 static bundle OK.');
