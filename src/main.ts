...
// v2.0.93 validation lineage only: root.dataset.v2090UiDebtCleanup = `stable-clean-${active}`;
  ...
  private async renderFishing(): Promise<void> {
    ...
    root.innerHTML = `
      ...
      <section class="v2153-battle-strip v2154-battle-strip" aria-live="polite" aria-label="낚시 실전 게이지">
        <div class="v2153-battle-row v2153-battle-catch"><span>포획</span><i><b data-v2153-catch-bar data-v2154-catch-bar></b></i><strong data-v2153-catch-value data-v2154-catch-value>0%</strong></div>
        <div class="v2153-battle-row v2153-battle-tension"><span>텐션</span><i><em data-v2153-safe-window data-v2154-safe-window></em><b data-v2153-tension-bar data-v2154-tension-bar></b></i><strong data-v2153-tension-value data-v2154-tension-value>50%</strong></div>
        <div class="v2153-battle-row v2153-battle-stamina"><span>저항</span><i><b data-v2153-stamina-bar data-v2154-stamina-bar></b></i><strong data-v2153-stamina-value data-v2154-stamina-value>100%</strong></div>
      </section>
      ...
      <div class="reel-panel glass-card hidden v2135-reel-panel v2137-reel-panel v2138-reel-panel v2139-reel-panel v2140-reel-panel v2142-reel-panel v2143-reel-panel v2144-reel-panel v2145-reel-panel v2146-reel-panel v2147-reel-panel v2148-reel-panel v2149-reel-panel v2150-reel-panel v2151-reel-panel v2152-reel-panel v2153-reel-panel v2154-reel-panel v205-reel-panel v2028-reel-panel v2029-reel-panel v2030-reel-panel v2031-reel-panel v2032-reel-panel v2033-reel-panel v2034-reel-panel v2035-reel-panel v2036-reel-panel v2037-reel-panel v2038-reel-panel v2039-reel-panel v2040-reel-panel v2041-reel-panel v2042-reel-panel v2043-reel-panel v2044-reel-panel v2045-reel-panel v2046-reel-panel v2047-reel-panel v2048-reel-panel v2049-reel-panel v2050-reel-panel v2051-reel-panel v2053-reel-panel v2054-reel-panel v2055-reel-panel v2057-reel-panel v2131-reel-panel v2132-reel-panel" id="reelPanel">
      ...
      <section class="v2055-reel-console v2057-reel-console v2073-reel-console v2131-reel-console v2132-reel-console v2134-reel-console v2135-reel-console v2136-reel-console v2137-reel-console v2138-reel-console v2139-reel-console v2140-reel-console v2142-reel-console v2143-reel-console v2144-reel-console v2145-reel-console v2146-reel-console v2147-reel-console v2148-reel-console v2149-reel-console v2150-reel-console v2151-reel-console v2152-reel-console v2153-reel-console v2154-reel-console hidden" id="reelConsole" aria-label="낚시 릴 조작 패널">
      ...
      <button class="v2053-reel-touch-zone v2054-reel-touch-zone v2131-reel-touch-zone v2132-reel-touch-zone v2134-reel-touch-zone v2135-reel-touch-zone v2136-reel-touch-zone v2137-reel-touch-zone v2138-reel-touch-zone v2139-reel-touch-zone v2140-reel-touch-zone v2142-reel-touch-zone v2143-reel-touch-zone v2144-reel-touch-zone v2145-reel-touch-zone v2146-reel-touch-zone v2147-reel-touch-zone v2148-reel-touch-zone v2149-reel-touch-zone v2150-reel-touch-zone v2151-reel-touch-zone v2152-reel-touch-zone v2153-reel-touch-zone v2154-reel-touch-zone hidden" type="button" aria-label="릴 감기 터치존"><strong>릴 감기</strong><span>누르는 동안 장력 상승</span><small>손을 떼면 자동으로 내려갑니다</small><em data-v2053-input-state>대기</em></button>`;
    dom.app.appendChild(root);
  ...
  private updateTensionUI(): void {
    ...
    const battleCatchBar = dom.app.querySelector<HTMLElement>('[data-v2154-catch-bar], [data-v2153-catch-bar]');
    const battleCatchValue = dom.app.querySelector<HTMLElement>('[data-v2154-catch-value], [data-v2153-catch-value]');
    const battleTensionBar = dom.app.querySelector<HTMLElement>('[data-v2154-tension-bar], [data-v2153-tension-bar]');
    const battleTensionValue = dom.app.querySelector<HTMLElement>('[data-v2154-tension-value], [data-v2153-tension-value]');
    const battleStaminaBar = dom.app.querySelector<HTMLElement>('[data-v2154-stamina-bar], [data-v2153-stamina-bar]');
    const battleStaminaValue = dom.app.querySelector<HTMLElement>('[data-v2154-stamina-value], [data-v2153-stamina-value]');
    const battleSafeWindow = dom.app.querySelector<HTMLElement>('[data-v2154-safe-window], [data-v2153-safe-window]');
