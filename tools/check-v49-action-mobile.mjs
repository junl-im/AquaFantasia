...
if (!sw.includes('v49-action-mobile-patch.js') || !(sw.includes('aqua-fantasia-v5.4.0-v49-action-20260612') || sw.includes('aqua-fantasia-v5.5.0-mobile-feel-20260612') || sw.includes('aqua-fantasia-v5.5.1-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612') || sw.includes('aqua-fantasia-v5.6.0-background-art-20260612')) || !sw.includes('AQUA_CLEAR_RUNTIME_CACHE')) fail('service worker v4.9 action cache markers missing');
if (!(manifest.includes('v4.9 Action Mobile Patch') || manifest.includes('v5.5 Mobile Feel')) || !(manifest.includes('4.9-action-20260612') || manifest.includes('5.5-mobile-feel-20260612') || manifest.includes('5.6.0-background-art-20260612'))) fail('manifest v4.9 action markers missing');
