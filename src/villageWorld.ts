...
function nearestDiamondTile(worldX: number, worldY: number): { x: number; y: number } {
  ...
  // v2.1.46: keep tile pixels unchanged and tighten the final diamond acceptance one more notch.
  ...
  return bestScore <= V2146_DIAMOND_TOUCH_SCORE_LIMIT ? best : base;
}
