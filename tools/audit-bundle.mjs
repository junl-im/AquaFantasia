...
const report = {
  ...
  runtime: {
    ...
    performanceFocus50: index.includes('initV50Runtime') && index.includes('v50-performance-panel') && sw.includes('aqua-fantasia-v5.0.0') && index.includes('v50-focus-canvas'),
    ...
    optimizedSave: index.includes('aqua_v5.0') && index.includes('aqua_v4.9') && index.includes('aqua_latest_state'),
...
if (missing.length || duplicateFishIds || fish.length < 174 || !report.runtime.runtimeDiet48 || !report.runtime.runtimeConnect49 || !report.runtime.performanceFocus50 || !report.runtime.renderer47 || !report.runtime.lightServiceWorker || !report.runtime.mobileGuards) process.exit(1);
