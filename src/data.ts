...
export const regions: RegionInfo[] = [
  ...
  { key: 'river', name: '산호숲 바다', subtitle: '수류가 빠른 중급 수역', bg: './assets/v9/bg/river.webp', difficulty: 1.14, waterSpeed: 0.92, color: '#5cf4d9', tide: '빠른 수류', unlockHint: '기본 해금' },
  { key: 'harbor', name: '노을 항구', subtitle: '노을 반사광 속 희귀어', bg: './assets/v9/bg/town_waterfront.webp', difficulty: 1.23, waterSpeed: 0.75, color: '#ffb45d', tide: '노을 반사', unlockHint: '기본 해금' },
  { key: 'deep', name: '깊은 바다', subtitle: '장력 변화가 큰 심해', bg: './assets/v9/bg/deepsea.webp', difficulty: 1.38, waterSpeed: 0.58, color: '#4a79ff', tide: '심해 압력', unlockHint: '성공 2회' },
  { key: 'palace', name: '용궁 정원', subtitle: '빛나는 유적과 고급 어종', bg: './assets/v9/bg/stream.webp', difficulty: 1.50, waterSpeed: 0.84, color: '#89f3ff', tide: '궁전 광류', unlockHint: '도감 5마리' },
  { key: 'dimension', name: '차원의 바다', subtitle: '보스 입질 확률 상승', bg: './assets/v9/bg/lake.webp', difficulty: 1.68, waterSpeed: 1.05, color: '#b487ff', tide: '차원 파동', unlockHint: '콤보 4회 또는 도감 10마리' },
  { key: 'glacier', name: '얼음 낚시터', subtitle: '차가운 수면과 미끄러운 장력', bg: './assets/v9/bg/lake.webp', difficulty: 1.42, waterSpeed: 0.46, color: '#b9f2ff', tide: '빙판 장력', unlockHint: '성공 8회' },
  { key: 'storm', name: '폭풍 외해', subtitle: '강한 파도와 높은 보상', bg: './assets/v9/bg/ocean.webp', difficulty: 1.78, waterSpeed: 1.18, color: '#6f8cff', tide: '폭풍 파도', unlockHint: '성공 12회' },
  { key: 'mangrove', name: '맹그로브 미궁', subtitle: '뿌리 사이로 숨은 희귀어', bg: './assets/v9/bg/stream.webp', difficulty: 1.55, waterSpeed: 0.72, color: '#5cffbd', tide: '뿌리 소용돌이', unlockHint: '도감 14마리' },
  { key: 'lunar', name: '달빛 산호해', subtitle: '밤바다 광원과 보스 그림자', bg: './assets/v9/bg/deepsea.webp', difficulty: 1.92, waterSpeed: 0.88, color: '#c7a6ff', tide: '달빛 너울', unlockHint: '최고 콤보 6회' },
  { key: 'reefFestival', name: '산호 축제섬', subtitle: '보너스 보상이 큰 이벤트 수역', bg: './assets/v9/bg/ocean.webp', difficulty: 1.28, waterSpeed: 1.02, color: '#61ffe2', tide: '축제 파문', unlockHint: '미션 2개 완료' },
];

export const fishDex: FishInfo[] = [
  { id: 'bubble', name: '바늘꼬리', regionKey: 'lake', region: '잔잔한 해변', img: './assets/v9/fish/fish_01.png', rarity: 'COMMON', reward: 55, weight: 42 },
  { id: 'lake', name: '투명메기', regionKey: 'lake', region: '잔잔한 해변', img: './assets/v9/fish/fish_02.png', rarity: 'COMMON', reward: 62, weight: 34 },
  { id: 'pearl', name: '화산쏨뱅이', regionKey: 'lake', region: '잔잔한 해변', img: './assets/v9/fish/fish_03.png', rarity: 'RARE', reward: 98, weight: 16 },
  { id: 'clown', name: '하늘가오리', regionKey: 'lake', region: '잔잔한 해변', img: './assets/v9/fish/fish_04.png', rarity: 'EPIC', reward: 135, weight: 8 },
  { id: 'river', name: '방울잉어', regionKey: 'river', region: '산호숲 바다', img: './assets/v9/fish/fish_05.png', rarity: 'COMMON', reward: 70, weight: 38 },
  { id: 'coral', name: '작은 금붕어', regionKey: 'river', region: '산호숲 바다', img: './assets/v9/fish/fish_06.png', rarity: 'RARE', reward: 115, weight: 22 },
...
export const navItems: Array<{ screen: SaveData['screen']; icon: string; label: string }> = [
  { screen: 'village', icon: './assets/v9/icons/nav_village.png', label: '마을' },
  { screen: 'fishing', icon: './assets/v9/icons/nav_fishing.png', label: '낚시' },
  { screen: 'gear', icon: './assets/v9/icons/nav_gear.png', label: '장비' },
  { screen: 'dex', icon: './assets/v9/icons/nav_dex.png', label: '도감' },
  { screen: 'shop', icon: './assets/v9/icons/nav_shop.png', label: '상점' },
  { screen: 'mission', icon: './assets/v9/icons/nav_mission.png', label: '미션' },
];
