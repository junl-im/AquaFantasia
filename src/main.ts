...
class AquaFantasiaGame {
  ...
  async boot(): Promise<void> {
    ...
    document.documentElement.dataset.assetPolish = 'v2020-asset-refinement-polish';
  ...
  private mountBottomNav(root: HTMLElement, active: Screen): void {
    ...
    const dockInlineStyles: Array<[string, string]> = [
      ...
      ['grid-template-columns', 'repeat(3, var(--v2016-dock-button, var(--v2014-dock-button, var(--v2013-dock-button, 50px))))'],
      ['grid-template-rows', 'repeat(2, var(--v2016-dock-button, var(--v2014-dock-button, var(--v2013-dock-button, 50px))))'], ['gap', 'var(--v2016-dock-gap, var(--v2014-dock-gap, var(--v2013-dock-gap, 4px)))'],
  ...
  private createCastButton(): void {
    ...
    this.uiLayer.innerHTML = `<button class="cast-button v2020-cast-button" type="button" aria-label="낚시 시작"><img class="v2020-cast-button-art" src="${ASSET.uiButtonSmallAqua}" alt="" aria-hidden="true" /><span class="cast-icon" aria-hidden="true"></span><strong>낚시 시작</strong></button>`;
