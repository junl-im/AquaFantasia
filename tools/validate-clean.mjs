...
if (!data.includes("APP_VERSION = '7.6.0'")) fail('APP_VERSION is not 7.6.0');
if (!data.includes('aqua-fantasia-v7.6.0-nav-fixed-25d-runtime')) fail('CACHE_NAME mismatch');
...
console.log('[validate-clean] Aqua Fantasia v7.6.0 nav fixed 2.5D runtime OK');
console.log(JSON.stringify({ ok:true, version:'7.6.0', files: walk(root).length }, null, 2));
