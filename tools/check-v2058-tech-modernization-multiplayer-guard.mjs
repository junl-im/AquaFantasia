...
if (!data.includes('tech-modernization-multiplayer-guard') && !data.includes('fishing-dialog-close-unification') && !data.includes('grounded-motion-polish') && !data.includes('loop-ui-button-audit')) fail('CACHE_NAME must keep v2058+ modernization lineage');
if (!sw.includes('tech-modernization-multiplayer-guard') && !sw.includes('fishing-dialog-close-unification') && !sw.includes('grounded-motion-polish') && !sw.includes('loop-ui-button-audit')) fail('service worker cache must keep v2058+ cache lineage');
