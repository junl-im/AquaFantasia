...
assert(pkg.version === '1.1.14', 'package version is v1.1.14');
assert(lock.version === '1.1.14' && lock.packages?.['']?.version === '1.1.14', 'package-lock root version is v1.1.14');
assert(data.includes("APP_VERSION = '1.1.14'"), 'APP_VERSION is v1.1.14');
assert(data.includes('aqua-fantasia-v1.1.14-button-style-hotfix'), 'data cache is v1.1.14');
assert(sw.includes('aqua-fantasia-v1.1.14-button-style-hotfix'), 'service worker cache is v1.1.14');
assert(offline.includes('v1.1.14'), 'offline page badge is v1.1.14');
assert(readme.includes('v1.1.14 Button Style Hotfix'), 'README documents v1.1.14');
