...
if (!(index.includes('v551-hotfix-runtime.js?v=5.5.1') || index.includes('v551-hotfix-runtime.js?v=5.5.2') || index.includes('v551-hotfix-runtime.js?v=5.5.5')) || !index.includes('updateViaCache')) fail('index hotfix/cache-bust markers missing');
if (!(index.includes('v53-casual-ux-polish.js?v=5.5.1') || index.includes('v53-casual-ux-polish.js?v=5.5.2') || index.includes('v53-casual-ux-polish.js?v=5.5.5')) || !(index.includes('v55-mobile-feel-runtime.js?v=5.5.1') || index.includes('v55-mobile-feel-runtime.js?v=5.5.2') || index.includes('v55-mobile-feel-runtime.js?v=5.5.5'))) fail('runtime module cache-bust markers missing');
if (!(sw.includes('aqua-fantasia-v5.5.1-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612')) || !sw.includes('./src/runtime/v551-hotfix-runtime.js') || !sw.includes('aqua-fantasia-v5.5.0-mobile-feel-20260612')) fail('service worker hotfix/migration markers missing');
