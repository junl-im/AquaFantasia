...
if (!index.includes("const APP_VERSION = '2.5.0'")) fail('APP_VERSION must be 2.5.0 for this patch.');
...
if (!sw.includes('aqua-fantasia-v2.5.0')) fail('Service worker cache version was not updated.');
