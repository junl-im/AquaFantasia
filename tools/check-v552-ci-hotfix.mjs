...
if (!(index.includes('v552-ci-runtime-guard.js?v=5.5.2') || index.includes('v552-ci-runtime-guard.js?v=5.5.5') || index.includes('v552-ci-runtime-guard.js?v=5.6.0') || index.includes('v552-ci-runtime-guard.js?v=5.6.1') || index.includes('v552-ci-runtime-guard.js?v=5.7.0')) || !index.includes('v5.5.2 Runtime & CI Hotfix')) fail('index v5.5.2 runtime/metadata missing');
if (!(sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612') || sw.includes('aqua-fantasia-v5.6.0-background-art-20260612') || sw.includes('aqua-fantasia-v5.6.1-ui-cleanup-20260612') || sw.includes('aqua-fantasia-v5.7.0-water-art-20260612')) || !sw.includes('./src/runtime/v552-ci-runtime-guard.js')) fail('service worker v5.5.2 cache entries missing');
...
if (!(state.includes("APP_VERSION = '5.5.2'") || state.includes("APP_VERSION = '5.5.5'") || state.includes("APP_VERSION = '5.6.0'") || state.includes("APP_VERSION = '5.6.1'") || state.includes("APP_VERSION = '5.7.0'")) || !(state.includes('aqua_v5.5.2') || state.includes('aqua_v5.5.5') || state.includes('aqua_v5.6.0') || state.includes('aqua_v5.6.1') || state.includes('aqua_v5.7.0'))) fail('state v5.5.2 markers missing');
