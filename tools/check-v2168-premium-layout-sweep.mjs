...
const fail = (msg) => { console.error(`[v2168] ${msg}`); process.exit(1); };
...
if (pkg.version !== '2.1.68') fail(`package.json version is ${pkg.version}`);
if (lock.version !== '2.1.68' || lock.packages?.['']?.version !== '2.1.68') fail('package-lock.json version mismatch');
if (!pkg.scripts?.validate?.includes('check-v2168-premium-layout-sweep.mjs')) fail('validate script must run v2.1.68 guard');
assertIncludes('src/data.ts', "APP_VERSION = '2.1.68'");
assertIncludes('src/data.ts', 'aqua-fantasia-v2.1.68-premium-layout-sweep');
assertIncludes('public/sw.js', 'aqua-fantasia-v2.1.68-premium-layout-sweep');
assertIncludes('public/offline.html', 'v2.1.68');
assertIncludes('README.md', '# AquaFantasia v2.1.68');
assertIncludes('README.md', '## v2.1.68 변경사항');
...
for (const token of [
  ...
  'dataset.v2168PremiumLayoutSweep',
  'v2168-premium-layout-fishing-shop-dock-sweep',
  'v2168-premium-layout-sweep-root',
  'installV2168PremiumLayoutSweepPass',
  'v2168-world-controls-aqua-lock',
  'v2168-top-menu-cell',
  'v2168-premium-aqua-ui-screen',
  'v2168-bottom-nav',
  'v2168-fishing-premium-screen',
  'v2168FishingCockpit',
  'v2168-battle-strip',
  'data-v2168-catch-bar',
  'data-v2168-tension-bar',
  'data-v2168-stamina-bar',
  'data-v2168-safe-window',
  'v2168-reel-console',
  'v2168-single-reel-button',
  'v2168-release-hidden',
  'v2168-shop-card',
  'v2168-shop-tag',
  'v2168-shop-price',
  'v2168TextBudget',
  'v2168ImageContainment',
  'v2168InputTone',
  'v2168LegacyBlocked',
...
for (const token of [
  ...
  'v2.1.68: premium layout sweep',
  '--v2167-menu-cell: 34px',
  '--v2168-menu-cell: 34px',
  '--v2168-menu-icon: 22px',
  '--v2168-menu-gap: 3px',
  '.v2168-world-controls-aqua-lock:not(.v2167-menu-panel-hidden)',
  'grid-template-columns: repeat(2, var(--v2168-menu-cell)) !important;',
  '.v2168-top-menu-cell::before',
  '.v2168-premium-aqua-ui-screen',
  '.bottom-nav.v2168-bottom-nav',
  '[data-v2168-image-containment="overflow-hidden-contain-clip"]',
  '.v2168-shop-card .v2168-shop-tag',
  '.v2168-shop-card .v2168-shop-price',
  'body[data-screen="fishing"] .v2168-bottom-nav',
  '.v2168-fishing-premium-screen:not([data-fishing-phase="reeling"]) .v2168-fishing-loadout',
  '.v2168-fishing-premium-screen[data-fishing-phase="reeling"] .v2168-battle-strip',
  '.v2168-fishing-premium-screen[data-fishing-phase="reeling"] .v2168-reel-console:not(.hidden)',
  '.v2168-single-reel-button',
  '.v2168-release-hidden',
  'max-height: 620px',
  '--v2168-menu-cell: 32px',
...
console.log('[v2168] premium layout sweep, compact fishing cockpit, shop/dock/menu guards, direction assets, and package guards passed');
