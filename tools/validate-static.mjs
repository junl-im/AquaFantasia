...
if (!/const APP_VERSION = '(?:5\.5\.(?:0|1|2|3|4|5)|5\.6\.0)'/.test(index)) fail('APP_VERSION must be v5.5.x or v5.6.0.');
...
if (!index.includes('v53-casual-ux-polish.js') || !index.includes('CASUAL RESULT SHOP 5.4')) fail('v5.3 casual runtime/panel is missing.');
...
if (!(sw.includes('aqua-fantasia-v5.6.0-background-art-20260612') || sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612') || sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.1-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.0-mobile-feel-20260612'))) fail('Service worker cache version must be v5.5.x or v5.6.0.');
...
if (!sw.includes('./src/runtime/v551-hotfix-runtime.js') || !sw.includes('./src/runtime/v552-ci-runtime-guard.js')) fail('v5.5.1/v5.5.2 hotfix cache entries are missing.');
if (!index.includes('v555-auto-cache-sweep.js') || !sw.includes('./src/runtime/v555-auto-cache-sweep.js')) fail('v5.5.5 auto cache sweep runtime/cache entry is missing.');
...
console.log('[validate-static] AquaFantasia v5.6.0 static bundle OK.');
