...
must(hasV2035CrossDiagonal || hasV2038DirectDiagonal || hasV2040ObservedDiagonal || hasV2042VisualDiagonal, 'villageWorld.ts missing v2035/v2038/v2040/v2042 diagonal repair lineage');
