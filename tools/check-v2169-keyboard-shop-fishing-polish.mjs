...
const fail = (msg) => { console.error(`[v2169] ${msg}`); process.exit(1); };
...
if (pkg.version !== '2.1.69') fail(`package.json version is ${pkg.version}`);
if (lock.version !== '2.1.69' || lock.packages?.['']?.version !== '2.1.69') fail('package-lock.json version mismatch');
if (!pkg.scripts?.validate?.includes('check-v2169-keyboard-shop-fishing-polish.mjs')) fail('validate script must run v2.1.69 guard');
assertIncludes('src/data.ts', "APP_VERSION = '2.1.69'");
assertIncludes('src/data.ts', 'aqua-fantasia-v2.1.69-keyboard-shop-fishing-polish');
assertIncludes('public/sw.js', 'aqua-fantasia-v2.1.69-keyboard-shop-fishing-polish');
assertIncludes('public/offline.html', 'v2.1.69');
assertIncludes('README.md', '# AquaFantasia v2.1.69');
assertIncludes('README.md', '## v2.1.69 변경사항');
...
for (const token of [
  'dataset.v2169KeyboardShopFishingPolish',
  'v2169-keyboard-shop-fishing-polish-root',
  'installV2169KeyboardShopFishingPolishPass',
  'v2169-village-keyboard-screen',
  'v2169-fishing-keyboard-polish-screen',
  'v2169FishingLayout',
  'v2169-fishing-loadout',
  'v2169-loadout-cell',
  'v2169-battle-strip',
  'v2169-reel-console',
  'v2169-single-reel-button',
  'v2169-release-hidden',
  'v2169-action-badge',
  'v2169-result-card',
  'v2169-result-actions',
  'v2169-shop-card',
...
for (const token of [
  'v2.1.69: WASD keyboard joystick parity',
  'html.v2169-keyboard-shop-fishing-polish-root .v2169-keyboard-joystick',
  'body[data-screen="fishing"] .v2169-fishing-loadout',
  '.v2169-loadout-cell',
  '.v2169-action-badge',
  'top: 50% !important;',
  '.v2169-fishing-keyboard-polish-screen[data-fishing-phase="reeling"] .v2169-battle-strip',
  'bottom: calc(env(safe-area-inset-bottom, 0px) + 126px) !important;',
  '.v2169-single-reel-button',
  '.v2169-result-actions button',
  '#toast-root .v2169-brief-toast.toast-shop',
...
console.log('[v2169] keyboard movement, shop toast, fishing loadout/gauge/result polish, direction assets, and package guards passed');
