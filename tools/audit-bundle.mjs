...
const report = {
  ...
  runtime: {
    ...
    mobileFeel55: index.includes('v55-mobile-feel-runtime.js') && index.includes('MOBILE FEEL 5.5') && (sw.includes('aqua-fantasia-v5.5.0-mobile-feel-20260612') || sw.includes('aqua-fantasia-v5.5.1-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612')),
