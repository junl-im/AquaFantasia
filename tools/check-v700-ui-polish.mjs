...
if (!data.includes("APP_VERSION = '7.0.0'") || !data.includes('aqua-fantasia-v7.0.0-premium-ui-polish')) fail('v7 data/cache missing');
if (!sw.includes('aqua-fantasia-v7.0.0-premium-ui-polish') || !sw.includes('v700_panel_soft.png')) fail('service worker v7 UI assets missing');
