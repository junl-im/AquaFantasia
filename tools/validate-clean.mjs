...
const required = [
  ...
  'public/sw.js','public/manifest.webmanifest','public/assets/screens/start_screen_clean_v750.webp','public/assets/v9/bg/ocean.webp','public/assets/v9/equipment/boat.png','public/assets/v9/fish/fish_01.png','public/assets/ui/v750_button_gold.png','public/assets/ui/v750_keep_on.png',
  'public/assets/v9/ui/bottom_nav_bar_deepblue.png','public/assets/v9/equipment/boat.png','public/assets/v9/bg/ocean.webp','public/assets/v9/fish/fish_01.png',
...
if (!data.includes("APP_VERSION = '8.0.0'")) fail('APP_VERSION is not 8.0.0');
if (!data.includes('aqua-fantasia-v8.0.0-ui-asset-rebuild')) fail('CACHE_NAME mismatch');
...
console.log('[validate-clean] Aqua Fantasia v8.0.0 UI asset rebuild OK');
console.log(JSON.stringify({ ok:true, version:'8.0.0', files: walk(root).length }, null, 2));
