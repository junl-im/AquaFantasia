...
must(main.includes("this.installV21133SingleGovernorLedgerPass();\n    this.installV21134RenderBudgetUiWriteLedgerPass();"), 'v2.1.134 must run after v2.1.133 handoff');
must(main.includes("dataset.v21133UiPolicy = 'handoff-to-v21134-render-budget-ui-write-ledger'"), 'v2.1.133 handoff to v2.1.134 missing');
must(main.includes("if (document.documentElement.dataset.v21134RenderBudgetUiWriteLedger === 'active')"), 'v2.1.133 install guard for v2.1.134 missing');
...
must(sync.includes('v21134MutedLegacyObserverCount') && sync.includes('v21134ObserverBudget') && sync.includes('v21134UiWriteBudget'), 'v2.1.134 observer/write ledgers missing');
