...
must(/^2\.0\.(3[0-9]|[4-9][0-9])$/.test(pkg.version), 'package.json version must preserve v2.0.30+ root repair lineage');
...
must(/actor\.targetTimer = (180 \+ Math\.random\(\) \* 620|40 \+ Math\.random\(\) \* 180)/.test(village), 'NPC immediate movement timer missing');
...
must(/\.v2-world-controls button \{[\s\S]*height: (38|40)px !important/.test(css), 'world control compact buttons missing');
