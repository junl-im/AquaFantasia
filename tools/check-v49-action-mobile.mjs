...
if (!sw.includes('v49-action-mobile-patch.js') || !(sw.includes('aqua-fantasia-v5.4.0-v49-action-20260612') || sw.includes('aqua-fantasia-v5.5.0-mobile-feel-20260612') || sw.includes('aqua-fantasia-v5.5.1-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612')) || !sw.includes('AQUA_CLEAR_RUNTIME_CACHE')) fail('service worker v4.9 action cache markers missing');
