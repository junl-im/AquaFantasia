...
if (!hasAny(state, ["APP_VERSION = '5.5.0'", "APP_VERSION = '5.5.1'", "APP_VERSION = '5.5.2'", "APP_VERSION = '5.5.5'", "APP_VERSION = '5.6.0'", "APP_VERSION = '5.6.1'", "APP_VERSION = '5.7.0'"]) || !state.includes('aqua_v5.5')) fail('state v5.5 version/save markers missing');
if (!index.includes('v55-mobile-feel-runtime.js') || !index.includes('v5.5 Mobile Feel') || !hasAny(index, ["const APP_VERSION = '5.5.0'", "const APP_VERSION = '5.5.1'", "const APP_VERSION = '5.5.2'", "const APP_VERSION = '5.5.5'", "const APP_VERSION = '5.6.0'", "const APP_VERSION = '5.6.1'", "const APP_VERSION = '5.7.0'"])) fail('index v5.5 markers missing');
