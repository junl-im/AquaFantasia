...
const sw = read('sw.js');
if (!(state.includes("APP_VERSION = '5.3.0'") || state.includes("APP_VERSION = '5.4.0'") || state.includes("APP_VERSION = '5.5.0'") || state.includes("APP_VERSION = '5.5.1'") || state.includes("APP_VERSION = '5.5.2'") || state.includes("APP_VERSION = '5.5.5'") || state.includes("APP_VERSION = '5.6.0'")) || !state.includes('aqua_v5.3')) fail('state v5.3 save/version marker missing');
