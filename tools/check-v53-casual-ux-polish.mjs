...
const sw = read('sw.js');
if (!(state.includes("APP_VERSION = '5.3.0'") || state.includes("APP_VERSION = '5.4.0'")) || !state.includes('aqua_v5.3')) fail('state v5.3 save/version marker missing');
...
if (!index.includes('v53-casual-ux-polish.js') || !(index.includes("const APP_VERSION = '5.3.0'") || index.includes("const APP_VERSION = '5.4.0'"))) fail('index v5.3 runtime marker missing');
