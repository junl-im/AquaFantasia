...
if (!/const APP_VERSION = '5\.5\.(?:0|1|2|3|4|5)'/.test(index)) fail('APP_VERSION must be v5.5.x.');
...
if (!(sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612') || sw.includes('aqua-fantasia-v5.5.2-runtime-ci-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.1-hotfix-20260612') || sw.includes('aqua-fantasia-v5.5.0-mobile-feel-20260612'))) fail('Service worker cache version must be v5.5.x.');
...
console.log('[validate-static] AquaFantasia v5.5.5 static bundle OK.');
