...
if (!data.includes("APP_VERSION = '7.1.0'")) fail('APP_VERSION is not 7.0.0');
...
if (!sw.includes('aqua-fantasia-v7.1.0-ui-dex-polish')) fail('service worker cache version mismatch');
...
if (pkg.version !== '7.1.0') fail('package version mismatch');
...
console.log('[validate-clean] Aqua Fantasia v7.1.0 start cleanup, back guard and bite guide OK');
console.log(JSON.stringify({ ok: true, version: '7.1.0', files: files.length, atlasFrames: Object.keys(atlas.frames).length }, null, 2));
