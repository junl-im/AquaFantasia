...
if (!(sw.includes('aqua-fantasia-v5.6.0-background-art-20260612') || sw.includes('aqua-fantasia-v5.5.5-auto-cache-sweep-20260612')) || !sw.includes('./src/runtime/v555-auto-cache-sweep.js')) fail('service worker v5.5.5/v5.6 cache version/entry missing');
...
if (!manifest.includes('Auto Cache Sweep') || !(manifest.includes('5.6.0-background-art-20260612') || manifest.includes('5.5.5-auto-cache-sweep-20260612'))) fail('manifest auto cache markers missing');
